...
const pages = ['About Us', 'Features', 'Features'];


const settings = [ <a className='a' href="/signin" style={{color:'black',textDecoration:'none'}}>Sign In</a>,  <a className='a' href="/signup" style={{color:'black', textDecoration:'none'}}>Sign Up</a>];
